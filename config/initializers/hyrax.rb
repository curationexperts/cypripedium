...
Hyrax.config do |config|
  ...
  # config.noid_minter_class = ActiveFedora::Noid::Minter::Db # Hyrax 3.x
  # config.noid_minter_class = Noid::Rails::Minter::Db # Hyrax 5.x
  ...
  config.geonames_username = 'mplsfedris' # Local
  # config.geonames_username = ENV['GEONAMES_USERNAME'] || '' # Hyrax 5.x
