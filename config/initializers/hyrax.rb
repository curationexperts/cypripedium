Hyrax.config do |config|
  ...
  config.geonames_username = 'mplsfedris'
  ...
  config.banner_image =  asset_path('https://raw.githubusercontent.com/MPLSFedResearch/cypripedium/master/app/assets/images/chalkboardcrop.jpg')
