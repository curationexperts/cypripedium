...
RSpec.describe 'New work creation', type: :system, js: true do
  ...
  before do
    ...
    default_admin_set = AdminSet.create!(id: Hyrax::AdminSetCreateService::DEFAULT_ID, title: Hyrax::AdminSetCreateService::DEFAULT_TITLE)
    ...
    workflow = Hyrax::AdminSetCreateService.new(admin_set: default_admin_set, creating_user: nil).send(:create_workflows_for, permission_template: permission_template)
